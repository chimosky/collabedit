...
class CollabEditActivity(activity.Activity):
    ...
    def _cursor_positon_changed_cb(self, edit, pos):
        self.button_bold.props.active =\
            self.edit.check_tag_at_offset("bold", pos)
        self.button_italic.props.active =\
            self.edit.check_tag_at_offset("italic", pos)
        self.button_underline.props.active =\
            self.edit.check_tag_at_offset("underline", pos)
    ...
    def setup_toolbar(self):
        ...
        self.toolbar.insert(
            ToolbarButton(page=edit_toolbar, icon_name="toolbar-edit"), -1)
        ...
        self.button_bold.connect(
            "toggled",
            lambda button: self.edit.toggle_bold())
        ...
        self.button_italic.connect(
            "toggled",
            lambda button: self.edit.toggle_italic())
        ...
        self.button_underline.connect(
            "toggled",
            lambda button: self.edit.toggle_underline())
